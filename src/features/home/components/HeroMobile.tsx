            ...
            <div className="sticky top-0 z-50 bg-bgPrimary py-5 border-b border-primaryBorder px-5">
                ...
                <div className="flex gap-3">
                    <div className="flex items-center flex-1 bg-[#2b1a0a] border border-primaryBorder rounded-xl px-4 py-2">
                        ...
                        className="flex-1 bg-transparent outline-none text-base text-textSecondary placeholder:text-textSecondary"
                        />
                    </div>
            ...
            <div className="px-5 pb-7 mt-5 border-b border-primaryBorder">
                <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-[#1a1107] via-[#2b1a0a] to-[#3b240c]">
                    ...
                    <div className="flex">
                        ...
                        <span className="bg-bgSecondary/90 text-black text-xs font-bold px-3 py-1 rounded-full w-fit mb-2">
                            INSCRIPCIONES 2026
                        </span>

                        <h1 className="text-3xl font-bold text-textPrimary leading-tight">
                            Aprende el Arte del{" "}
                        ...
                        <p className="text-base text-textSecondary mt-2 leading-relaxed">
                            Cursos de acordeón, caja y guacharaca con los mejores maestros.
                        </p>

                        <button className="mt-4 bg-bgSecondary text-black text-sm font-bold px-4 py-2 rounded-lg w-fit">
                            Comenzar Ahora
                        </button>
